(function () {
      ...
      return _c(
        ...
        [
          _c("sensor-chart-modal", {
            ...
            attrs: { api: _vm.api },
            on: { hidden: _vm.onHiddenModal }
          }),
          _vm._v(" "),
          _vm._l(_vm.deviceArr, function(device, i) {
            return [
              _vm.numberByNameArr[device.number] &&
              _vm.numberByNameArr[device.number].length
                ? _c("div", { key: i, staticClass: "card w-100 mb-3" }, [
                    _c("div", { staticClass: "card-body" }, [
                      _c(
                        "div",
                        {
                          staticClass:
                            "w-100 d-flex flex-wrap justify-content-start"
                        },
                        _vm._l(_vm.numberByNameArr[device.number], function(
                          data,
                          key
                        ) {
                          return _c(
                            "div",
                            { key: key, staticClass: "w-20 col-12 p-1" },
                            [
                              _c(
                                "div",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.onClickChannel(data.name, device)
                                    }
                                  }
                                },
                                [
                                  _c(
                                    ...
                                    [
                                      _c("span", { staticClass: "text-truncate" }, [
                                        _vm._v(
                                          "Device number : " + _vm._s(device.number)
                                        )
                                      ])
                                    ]
                                  ),
                                      ...
                                      _c("div", { staticClass: "col-9" }, [
                                        _c("div", { staticClass: "row" }, [
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "col-12 text-center text-truncate"
                                            },
                                            [
                                              _vm._v(
                                                "\n                                                Sensor Name\n                                            "
                                        ...
                                        _c("div", { staticClass: "row" }, [
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "col-12 text-center text-truncate text-danger"
                                            },
                                            [
                                              _vm._v(
                                                "\n                                                " +
                ...
                : _c("div", { key: i, staticClass: "card w-100 mb-3" }, [
                    _c("div", { staticClass: "card-body" }, [
                      _c("div", { staticClass: "text-center" }, [
                        _vm._v("Device number : " + _vm._s(device.number))
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "h2 text-center text-secondary" }, [
                        _vm._v("None data")
                      ])
                    ])
                  ])
    ...
    __vue_render__._withStripped = true;
      ...
      var SerialMonitoringPage = normalizeComponent_1(
    ...
    new Vue({
        el: '#container',
        components: {
            'serial-monitoring-page': SerialMonitoringPage
        }
    });
